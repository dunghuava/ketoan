...
if(!isset($_SESSION))
{
	...
	$hinh_anh = $d->o_fet("select * from #_products_hinhanh where id = '".$id."'");
	if($d->o_que("delete from #_products_hinhanh where id = '".$id."'")){
...
?>
<?php 
	$hinhanh =  $d->o_fet("select * from #_products_hinhanh where id_sp ='".$idsp."'");
